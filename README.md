...
domain_experience:
  - "B2B SaaS"
  - "Loyalty CRM"
  - "Point-of-Sale Systems (Traditional & SoftPOS)"
how_i_work:
...
- Set up functional, unit, and integration tests, and a CI/CD pipeline via GitHub Actions
